...
class QuizGame:
    ...
    def get_default_quizzes(self) -> list:
        ...
        return [
            Quiz("나의 이름은?", ["차우람", "차세람", "차가람", "람가차"], 3),
            Quiz("나의 롤 최고 티어는?", ["다이아몬드", "마스터", "그랜드마스터", "챌린저"], 4),
            Quiz("내가 밴드부 정기공연에서 맡은 적이 없는 세션은?", ["기타", "베이스", "드럼", "건반"], 3),
            Quiz("내가 좋아하는 아티스트는?", ["한로로", "유다빈밴드", "케로로밴드", "The Weeknd"], 4),
            Quiz("2-handled torus의 second homology group은?", ["\033[1mZ\033[0m", "\033[1mZ\033[0m²", "\033[1mZ\033[0m³", "\033[1mZ\033[0m⁴"], 1)
         ]
